...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spider62ps8694 && scrapy crawl "+tableName+"Spider -a databaseName=djangoy6p0a600"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=djangoy6p0a600"
        os.system(cmd)
