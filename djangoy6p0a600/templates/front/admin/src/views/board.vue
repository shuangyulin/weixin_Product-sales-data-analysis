<template>
	<div class="content" :style='{"alignContent":"flex-start","padding":"0","overflow":"hidden","background":"rgb(17, 17, 17)","flexDirection":"column","display":"flex","width":"100%","position":"relative","user-select":"none","height":"100%"}'>
		<div :style='{"width":"100%","padding":"0","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20250103/621ebcdea35c476a93c7565e93276e51.png) center center/100% 100%","height":"100px"}'>
			<!-- 标题 -->
			<div :style='{"padding":"0 0 0 40px","margin":"0","color":"transparent","textAlign":"left","background":"linear-gradient(to bottom,#cce9e8, rgba(0, 206, 209, 1)) text","width":"auto","letterSpacing":"2px","lineHeight":"80px","fontSize":"28px","fontWeight":"700","height":"100%"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
			<div :style='{"top":"0","color":"#fff","display":"inline-block","lineHeight":"80px","fontSize":"16px","position":"absolute","right":"20px","height":"80px"}'>{{ dates }} <span @click="backClick" style="cursor:pointer;padding: 0 0 0 8px;">管理界面</span></div>
		</div>
		<div :style='{"padding":"0 20px 20px 20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"20%","padding":"0","flexDirection":"column","background":"none","display":"flex","gap":"15px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhibodaihuoChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/48056e48009f429ebcf90571a4f36284.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="zhibodaihuoChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/48056e48009f429ebcf90571a4f36284.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="zhibodaihuoChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"padding":"0","margin":"0 20px","flexWrap":"wrap","flexDirection":"row","flex":"auto","background":"none","display":"flex","width":"0","height":"100%"}'>
				<!-- 统计 -->
				<div :style='{"alignContent":"center","padding":"0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"12px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"160px"}'>
					...
					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(\"https://codegen.caihongy.cn/20250103/bf51fb90c3a24185bb215cd4d6b411cd.png\")  no-repeat center -110px","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"126px","position":"relative","justifyContent":"space-evenly","height":"160px","maxWidth":"200px"}'>
						...
						<div :style='{"padding":"80px 0 0 0","alignItems":"center","flexWrap":"wrap","flexDirection":"column","flex":"auto","display":"flex","width":"0","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","height":"24px"}'>直播带货总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(250, 212, 0)","fontWeight":"700","order":"20"}'>{{zhibodaihuoCount}}</div>
						</div>
					</div>

					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(\"https://codegen.caihongy.cn/20250103/463f77252d6c4b4cafa5ad16ee476159.png\")  no-repeat center -110px","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"126px","position":"relative","justifyContent":"space-evenly","height":"160px","maxWidth":"200px"}'>
						<div :style='{"width":"43px","margin":"0 10px","flex":"none","display":"none","height":"43px"}'></div>
						<div :style='{"padding":"80px 0 0 0","alignItems":"center","flexWrap":"wrap","flexDirection":"column","flex":"auto","display":"flex","width":"0","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","height":"24px"}'>直播带货预测总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(250, 212, 0)","fontWeight":"700","order":"20"}'>{{zhibodaihuoforecastCount}}</div>
						</div>
					</div>

					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(\"https://codegen.caihongy.cn/20250103/4fc3575a4296495895b539ad8e0b014f.png\")  no-repeat center -110px","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"126px","position":"relative","justifyContent":"space-evenly","height":"160px","maxWidth":"200px"}'>
						<div :style='{"width":"43px","margin":"0 10px","flex":"none","display":"none","height":"43px"}'></div>
						<div :style='{"padding":"80px 0 0 0","alignItems":"center","flexWrap":"wrap","flexDirection":"column","flex":"auto","display":"flex","width":"0","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","height":"24px"}'>用户总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(250, 212, 0)","fontWeight":"700","order":"20"}'>{{yonghuCount}}</div>
						</div>
					</div>

					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(\"https://codegen.caihongy.cn/20250103/3b06f4a375a04a2099111c151d3eb376.png\")  no-repeat center -110px","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"126px","position":"relative","justifyContent":"space-evenly","height":"160px","maxWidth":"200px"}'>
						<div :style='{"width":"43px","margin":"0 10px","flex":"none","display":"none","height":"43px"}'></div>
						<div :style='{"padding":"80px 0 0 0","alignItems":"center","flexWrap":"wrap","flexDirection":"column","flex":"auto","display":"flex","width":"0","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","height":"24px"}'>商家总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(250, 212, 0)","fontWeight":"700","order":"20"}'>{{shangjiaCount}}</div>
						</div>
					</div>
					...
					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(\"https://codegen.caihongy.cn/20250103/bf51fb90c3a24185bb215cd4d6b411cd.png\")  no-repeat center -110px","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"126px","position":"relative","justifyContent":"space-evenly","height":"160px","maxWidth":"200px"}'>
						<div :style='{"width":"43px","margin":"0 10px","flex":"none","display":"none","height":"43px"}'></div>
						<div :style='{"padding":"80px 0 0 0","alignItems":"center","flexWrap":"wrap","flexDirection":"column","flex":"auto","display":"flex","width":"0","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","height":"24px"}'>商品信息总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(250, 212, 0)","fontWeight":"700","order":"20"}'>{{shangpinxinxiCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts7">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhibodaihuoChart7" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts8">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/7e1b7534a83645308b87aa0f5fe63e86.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhibodaihuoChart8" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts9">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/7e1b7534a83645308b87aa0f5fe63e86.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhibodaihuoChart9" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts10">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/7e1b7534a83645308b87aa0f5fe63e86.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<el-table id="zhibodaihuoTable" :data="zhibodaihuoList" border :stripe="true" :style='{"border":"none !important","width":"100%","padding":"0","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="title" label="标题"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="nickname" label="作者昵称"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="duration" label="时长"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="cjtime" label="创建时间"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="detailurl" label="详情地址"/>
						</el-table-column>
					</el-table>
				</div>
				<div class="forecast-box" :style='{"padding":"20px","margin":"0","alignItems":"flex-start","flexDirection":"column","display":"flex","transition":"0.3s","justifyContent":"flex-start","flexWrap":"wrap","background":"none","flex":"0 0 auto","gap":"8px","width":"25%","height":"calc(60% - 80px)","order":"2"}'>
					<div :style='{"border":"1px solid rgba(0, 206, 209, 1)","padding":"0 10px","margin":"0","borderRadius":"10px","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","fontSize":"14px","color":"#999","textAlign":"left"}'>
							标题
						</div>
						<input :style='{"border":"none","margin":"0 0 0 10px","outline":"none","color":"#fff","flex":"auto","background":"none","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.title" placeholder="请输入标题"></input>
					</div>
					<div :style='{"border":"1px solid rgba(0, 206, 209, 1)","padding":"0 10px","margin":"0","borderRadius":"10px","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","fontSize":"14px","color":"#999","textAlign":"left"}'>
							作者昵称
						</div>
						<input :style='{"border":"none","margin":"0 0 0 10px","outline":"none","color":"#fff","flex":"auto","background":"none","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.nickname" placeholder="请输入作者昵称"></input>
					</div>
					<div :style='{"border":"1px solid rgba(0, 206, 209, 1)","padding":"0 10px","margin":"0","borderRadius":"10px","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","fontSize":"14px","color":"#999","textAlign":"left"}'>
							时长
						</div>
						<input :style='{"border":"none","margin":"0 0 0 10px","outline":"none","color":"#fff","flex":"auto","background":"none","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.duration" placeholder="请输入时长"></input>
					</div>
					<div :style='{"border":"1px solid rgba(0, 206, 209, 1)","padding":"0 10px","margin":"0","borderRadius":"10px","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","fontSize":"14px","color":"#999","textAlign":"left"}'>
							收藏数
						</div>
						<input :style='{"border":"none","margin":"0 0 0 10px","outline":"none","color":"#fff","flex":"auto","background":"none","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.collectcount" placeholder="请输入收藏数"></input>
					</div>
					<div :style='{"width":"100%","letterSpacing":"2px","fontSize":"18px","color":"#fff","fontWeight":"500","order":"1"}'>
						预测点赞数：{{form.diggcount}}
					</div>
			...
			<div :style='{"padding":"0","flexWrap":"wrap","flexDirection":"column","background":"none","display":"flex","gap":"15px","width":"20%"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="zhibodaihuoChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/e010405843e1480eb2b0ceae12587f47.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhibodaihuoChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/e010405843e1480eb2b0ceae12587f47.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhibodaihuoChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		data() {
			return {
				...
				myChart0: null,
				zhibodaihuoList: [],
				zhibodaihuoTimer: null,
				systemIntroductionDetail: null,
				dates: '',
				zhibodaihuoCount: 0,
				zhibodaihuoforecastCount: 0,
				yonghuCount: 0,
				shangjiaCount: 0,
		...
		mounted(){
			this.init();
			this.getzhibodaihuoList()
		},
		created() {
			this.$nextTick(()=>{
				this.times()
				setTimeout(()=>{
					this.getzhibodaihuoCount();
					this.zhibodaihuoChat1();
					this.zhibodaihuoChat2();
					this.zhibodaihuoChat3();
					this.zhibodaihuoChat4();
					this.zhibodaihuoChat5();
					this.zhibodaihuoChat6();
					this.zhibodaihuoChat7();
					this.zhibodaihuoChat8();
					this.zhibodaihuoChat9();
					this.getzhibodaihuoforecastCount();
					this.getyonghuCount();
		...
		methods:{
				...
				this.$confirm(`是否进行数据预测?`, "提示", {
					...
					this.$http({
						...
						if(res.data&&res.data.code==0){
							...
							this.$http({
								url: 'zhibodaihuoforecast/forecast',
								method: 'post',
								data: this.forecastForm
							}).then(obj=>{
								if(obj.data&&obj.data.code==0){
									this.$http({
										url: 'zhibodaihuoforecast/info/' + res.data.data,
										method: 'get'
									}).then(rs2=>{
			...
			getzhibodaihuoList() {
				...
				this.$http({
					url: "zhibodaihuo/page",
					method: "get",
					params: params
				}).then(({ data }) => {
					if (data && data.code === 0) {
						this.zhibodaihuoList = data.data.list;
						let div = document.getElementById('zhibodaihuoTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.zhibodaihuoTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.zhibodaihuoTimer);
						})
			...
			getzhibodaihuoCount() {
				this.$http({
					url: `zhibodaihuo/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.zhibodaihuoCount = data.data
					}
				})
			},
			//统计接口1
			zhibodaihuoChat1() {
				this.$nextTick(()=>{
					...
					var zhibodaihuoChart1 = echarts.init(document.getElementById("zhibodaihuoChart1"),'macarons');
					this.$http({
						url: `zhibodaihuo/value/title/duration`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							zhibodaihuoChart1.setOption(option);
				
							this.myChartInterval(2, option.yAxis.data, option.series[0].data, zhibodaihuoChart1)

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								zhibodaihuoChart1.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			zhibodaihuoChat2() {
				this.$nextTick(()=>{
					...
					var zhibodaihuoChart2 = echarts.init(document.getElementById("zhibodaihuoChart2"),'macarons');
					this.$http({
						url: `zhibodaihuo/value/title/collectcount`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							zhibodaihuoChart2.setOption(option);
				
							this.myChartInterval(1, option.xAxis.data, option.series[0].data, zhibodaihuoChart2)

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								zhibodaihuoChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			zhibodaihuoChat3() {
				this.$nextTick(()=>{
					...
					var zhibodaihuoChart3 = echarts.init(document.getElementById("zhibodaihuoChart3"),'macarons');
					this.$http({
						url: `zhibodaihuo/value/title/commentcount`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							zhibodaihuoChart3.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								zhibodaihuoChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			zhibodaihuoChat4() {
				this.$nextTick(()=>{
					...
					var zhibodaihuoChart4 = echarts.init(document.getElementById("zhibodaihuoChart4"),'macarons');
					this.$http({
						url: `zhibodaihuo/value/title/diggcount`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							zhibodaihuoChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								zhibodaihuoChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			zhibodaihuoChat5() {
				this.$nextTick(()=>{
					...
					var zhibodaihuoChart5 = echarts.init(document.getElementById("zhibodaihuoChart5"),'macarons');
					this.$http({
						url: `zhibodaihuo/value/title/sharecount`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							zhibodaihuoChart5.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								zhibodaihuoChart5.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			zhibodaihuoChat6() {
				this.$nextTick(()=>{
					...
					var zhibodaihuoChart6 = echarts.init(document.getElementById("zhibodaihuoChart6"),'macarons');
					this.$http({
						url: `zhibodaihuo/value/nickname/duration`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							zhibodaihuoChart6.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								zhibodaihuoChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			zhibodaihuoChat7() {
				this.$nextTick(()=>{
					...
					var zhibodaihuoChart7 = echarts.init(document.getElementById("zhibodaihuoChart7"),'macarons');
					this.$http({
						url: `zhibodaihuo/value/nickname/diggcount`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							zhibodaihuoChart7.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								zhibodaihuoChart7.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
				...
				this.$nextTick(()=>{
					...
					this.$http({
						...
						if (data && data.code === 0) {
							...
							var option = {};
							this.wordclouds(pArray,'zhibodaihuoChart8');
			...
			zhibodaihuoChat9() {
				this.$nextTick(()=>{
					...
					var zhibodaihuoChart9 = echarts.init(document.getElementById("zhibodaihuoChart9"),'macarons');
					this.$http({
						url: "zhibodaihuo/group/nickname",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							zhibodaihuoChart9.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								zhibodaihuoChart9.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			getzhibodaihuoforecastCount() {
				this.$http({
					url: `zhibodaihuoforecast/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.zhibodaihuoforecastCount = data.data
					}
				})
			},
			getyonghuCount() {
